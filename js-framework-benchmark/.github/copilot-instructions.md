...
5. Perform a security audit especially regarding supply chain attacks. To clarify: Malicious packages are inacceptable, even severe security issues in dependencies don't matter for the benchmark. Report findings, but do _not_ try to bump versions on your own decisions.
