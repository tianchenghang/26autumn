...
import { BenchmarkOptions, config as defaultConfig, ErrorAndWarning, FrameworkData, Config, wait } from "./common.js";
...
export async function executeBenchmark(
  ...
  console.log(
    `=> Duration for ${benchmark.benchmarkInfo.id} and framework ${framework.name}: ${duration.toFixed(2)} ms`
  );
