...
export const benchRemove = new (class extends CPUBenchmarkPlaywright {
  ...
  async init(browser: Browser, page: Page) {
    ...
    await checkElementContainsText(
      page,
      `tbody>tr:nth-of-type(${this.rowsToSkip + 1})>td:nth-of-type(1)`,
      `${this.rowsToSkip + this.benchmarkInfo.warmupCount + 1}`
    );
    await checkElementContainsText(
      page,
      `tbody>tr:nth-of-type(${this.rowsToSkip})>td:nth-of-type(1)`,
      `${this.rowsToSkip}`
    );
    ...
    await checkElementContainsText(
      page,
      `tbody>tr:nth-of-type(${this.rowsToSkip + 2})>td:nth-of-type(1)`,
