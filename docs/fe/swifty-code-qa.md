...
- [第一部分：整体架构设计（Q1-Q7）](#第一部分整体架构设计)
- [第二部分：进程通信与协议设计（Q8-Q13）](#第二部分进程通信与协议设计)
- [第三部分：Agent 核心机制（Q14-Q23）](#第三部分agent-核心机制)
- [第四部分：权限与安全（Q24-Q28）](#第四部分权限与安全)
- [第五部分：终端 UI / 前端工程（Q29-Q38）](#第五部分终端-ui--前端工程面试重点)
- [第六部分：会话、记忆与状态管理（Q39-Q43）](#第六部分会话记忆与状态管理)
- [第七部分：扩展性与集成（Q44-Q47）](#第七部分扩展性与集成)
- [第八部分：工程化与可观测性（Q48-Q52）](#第八部分工程化与可观测性)
- [第九部分：开放性问题与架构权衡（Q53-Q58）](#第九部分开放性问题与架构权衡)
- [附录 A：速查表](#附录-a速查表)
