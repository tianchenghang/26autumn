...
- [一、项目整体架构与设计决策（Q1–Q6）](#一-项目整体架构与设计决策)
- [二、Agent 核心循环与异步迭代（Q7–Q13）](#二-agent-核心循环与异步迭代)
- [三、LLM 抽象层与流式协议（Q14–Q19）](#三-llm-抽象层与流式协议)
- [四、工具系统与延迟加载（Q20–Q24）](#四-工具系统与延迟加载)
- [五、权限系统与 OS 沙箱（Q25–Q29）](#五-权限系统与-os-沙箱)
- [六、TUI 渲染层与性能优化（Q30–Q38）](#六-tui-渲染层与性能优化)
- [七、上下文管理与压缩（Q39–Q44）](#七-上下文管理与压缩)
- [八、会话持久化、记忆与钩子（Q45–Q49）](#八-会话持久化-记忆与钩子)
- [九、多智能体、技能与 MCP（Q50–Q54）](#九-多智能体-技能与-mcp)
- [十、工程化：构建、测试与配置（Q55–Q58）](#十-工程化-构建-测试与配置)
- [十一、入口与运行模式深挖（Q59–Q64）](#十一-入口与运行模式深挖)
- [十二、斜杠命令系统与用户扩展（Q65–Q69）](#十二-斜杠命令系统与用户扩展)
- [十三、基础设施模块（Q70–Q75）](#十三-基础设施模块)
- [十四、会话生命周期命令（Q76–Q78）](#十四-会话生命周期命令)
- [十五、手写代码题（Q79–Q86）](#十五-手写代码题)
- [十六、场景设计题（Q87–Q93）](#十六-场景设计题)
- [十七、权衡与开放题（Q94–Q100）](#十七-权衡与开放题)
