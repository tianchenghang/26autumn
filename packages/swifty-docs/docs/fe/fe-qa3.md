...
- [1. 什么是服务降级，它和服务熔断有什么区别?](#1-什么是服务降级它和服务熔断有什么区别)
- [2. 熔断器的三种状态是怎么流转的?](#2-熔断器的三种状态是怎么流转的)
- [3. 常见的限流算法有哪些，各自适用什么场景?](#3-常见的限流算法有哪些各自适用什么场景)
- [4. 前端如何实现服务降级?](#4-前端如何实现服务降级)
- [5. 限流在前端和后端分别怎么做?](#5-限流在前端和后端分别怎么做)
- [6. 分布式系统中如何做全链路降级?](#6-分布式系统中如何做全链路降级)
- [7. Sentinel 和 Hystrix 在熔断限流上的对比?](#7-sentinel-和-hystrix-在熔断限流上的对比)
- [8. 如何设计一个自适应限流算法?](#8-如何设计一个自适应限流算法)
- [9. 前端监控 SDK 的上报限流怎么做?](#9-前端监控-sdk-的上报限流怎么做)
- [10. 熔断和降级在 BFF 层如何落地?](#10-熔断和降级在-bff-层如何落地)
...
![熔断器状态流转图](../assets/circuit-breaker-states.png)
